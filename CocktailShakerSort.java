...
public class CocktailShakerSort {
	...
	public static void main(String[] args) {
		...
		cocktailShakerSort(array1);
		cocktailShakerSort(array2);
		cocktailShakerSort(array3);
		cocktailShakerSort(array4);
	    cocktailShakerSort(array5);
		cocktailShakerSort(array6);
		cocktailShakerSort(array7);
	...
	public static void cocktailShakerSort(int[] a) {
		boolean swapsForward = true;
		boolean swapsBackward = true;
		while (swapsForward && swapsBackward) {
			swapsForward = false;
			swapsBackward = false;
