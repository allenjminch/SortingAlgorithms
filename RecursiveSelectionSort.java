...
public class RecursiveSelectionSort {
	...
	public static void main(String[] args) {
		...
		recursiveSelectionSort(array2);
		recursiveSelectionSort(array3);
		recursiveSelectionSort(array4);
	    recursiveSelectionSort(array5);
		recursiveSelectionSort(array6);
		recursiveSelectionSort(array7);
	...
	private static void recursiveSelectionSort(int[] a, int index) {
		if (index < a.length - 1) {
		    int minIndex = index;
			...
			recursiveSelectionSort(a, index + 1);
		}
	}
	
	private static void recursiveSelectionSort(int[] a) {
