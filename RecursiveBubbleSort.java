...
public class RecursiveBubbleSort {
	...
	public static void main(String[] args) {
		...
		recursiveBubbleSort(array1);
		recursiveBubbleSort(array2);
		recursiveBubbleSort(array3);
		recursiveBubbleSort(array4);
		recursiveBubbleSort(array5);
		recursiveBubbleSort(array6);
		recursiveBubbleSort(array7);
	...
	private static boolean bubble(int[] a, int i) {
